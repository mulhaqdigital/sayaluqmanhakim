        ...
        <div className="relative size-full transform-3d group-hover:rotate-x-8 group-hover:rotate-y-12 group-hover:translate-z-16 transition-all duration-700 ease-out">
          ...
          <div className="relative z-10 size-full rounded-2xl overflow-hidden shadow-2xl shadow-primary/20">
            <div className={cn(
              ...
              isRight ? "translate-x-full group-hover:-translate-x-full" : "-translate-x-full group-hover:translate-x-full"
            )} />
            <div className={cn(
              "absolute inset-0 z-[15] pointer-events-none",
              isRight
                ? "bg-gradient-to-l from-background from-0% via-background/85 via-[15%] to-transparent to-[40%]"
                : "bg-gradient-to-r from-background from-0% via-background/85 via-[15%] to-transparent to-[40%]"
            )} />
            <Image
              src={lightSrc}
              alt={`${alt} - Light Mode`}
